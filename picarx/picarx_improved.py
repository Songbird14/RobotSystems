...
#print out all logging commands 
logging.getLogger().setLevel(logging.DEBUG) 
#add logging.debug(message) to where want line of code logged with message added 

try: 
    from robot_hat import Pin, ADC, PWM, Servo, fileDB
    from robot_hat import Grayscale_Module, Ultrasonic, utils
    on_the_robot = True
    logging.debug('Thinks the robot_hat is attatched')
except ImportError:
    import sys
    ...
    on_the_robot = False
    logging.debug('Thinks the robot_hat is not attatched')
import time
